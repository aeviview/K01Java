...
class Orange
{
	...
	{
		System.out.println("오렌지의당도는 "+ sugar + " 입니다");
	}
...
class FruitBox
{
	...
	public void store(Object item) //store : 담는다는 뜻
	{
		this.item = item;
	}
	public Object pullOut() //pullOut : 꺼낸다는뜻
	{
		return item;
	}
}
...
public class Ex01GenericBasic
{
	...
	public static void main(String[] args)
	{
		...
		//OrangeBox에 Orange객체를 생성한 후 저장하고 정보 출력한다
		...
		/*
		 ...
		 다른객체를 저장하기 위해서 또 다른 Box클래스를 생성해야 한다.
		 */
		/*
		...
		*/
		...
		/*
		 Object를 기반으로 한 FruetBox는 구현에는 편리하나 코드 레벨에서
		...
		/*
		FruitBox fBox2 = new FruitBox("당도가 30인 오렌지"); => 런타임 에러 발생
