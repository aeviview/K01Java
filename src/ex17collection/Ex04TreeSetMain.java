...
/*
 TreeSet<T> 컬렉션
 	...
 	- Set의 기본적인 특성은 동일하나, Tree 알고리즘을 통해 정렬되어 저장된다.
 	- 정렬의 기준은 개발자가 직접 정의할 수 있다.
 	- 정렬의 기준을정하기 위해 Comparable<T> 인터페이스를 구현해야 한다.
 */
class MyString implements Comparable<MyString>
{
	...
	/*
	 ...
	 문자열의 길이 등 다양하게 설정할 수 있다.
	 아래 코드는 오름차순(작은 것 => 큰 것) 정렬일때 사용한다.
...
public class Ex04TreeSetMain 
{
	...
	public static void main(String[] args) 
	{
		...
		/*
		 - 문자열의 길이가 정렬의 기준일 때는 아래 객체 중 7글자인 KOSMOXX는 1개만 삽입된다.
		 - 문자열을 compareTo()를 통해 비교해서 정렬할 때는 모든 문자열이 Set에 삽입된다.
		 */
