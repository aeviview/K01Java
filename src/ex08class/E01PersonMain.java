...
/*
 [추상화]
  - 현실세계의 사물을 클래스로 형상화 하는 것을 추상화라고 한다.
  	Person 클래스는 "사람"의 일반적인 사항을 추상화하고 있다.
 */
class Person {
		...
		//			클래스 외부 : 다른 클래스, 여기서는 밑에 PersonMain 클래스를 말한다.
		public void eat() //public은 생략가능!
		{
...
public class E01PersonMain {
	...
	public static void main(String[] args) {
		...
		/*
		 Person 클래스를 통해 인스턴스(객체)를 생성한다.
		 생성시 할당된 주소값이 반환된다.
		 */
		Person person = new Person();
		
		// 객체의 참조변수를 이용해서 멤버메소드를 호출 할 수 있다.
		person.eat();
		person.sleep();
