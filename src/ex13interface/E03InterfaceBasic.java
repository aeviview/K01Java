...
/*
 <인터페이스(interface)>
 	...
 	- 추상클래스와 동일하게 상속을 목적으로 제작되므로
 		구현받은 하위클래스에서 반드시 오버라이딩 해야한다.
...
{
	//public MyInterface1() {} 에러발생(생성자는 사용불가)
...
class MyClass implements MyInterface1, MyInterface2
{
	...
	//인터페이스에 동일한 이름의 추상메소드가 존재하는 경우, 하나만 오버라이딩 한다.
