...
/*
	 if문(조건문, 분기문)
	 	...
	 	- 즉, 결과 값이 boolean타입(true, false)이어야 한다.
...
//		}
		...
		/*
		 if(조건식); => 조건식에 상관없이 다음 문장이 실행되는 형태로
		 			세미클론은 문장의 끝을 나타내므로 사용에 주의해야 한다.
		 */
		...
		/*
		 ...
		 단, 실행문이 2개 이상인 경우에는 한 문장에만 실행되므로 주의해야 한다. 
		 */
...
//		System.out.println("입력한문자:" + (char)asciiCode);
		...
		/*
		 ...
		 '0' => 48
		 '9' => 57이므로 해당 구간안에 있다면 숫자로 판단할 수 있다.
		...
		/*
		 -아스키코드값 모를 때 구현 방법
		 char형 문자는 메모리에 저장할 때 아스키코드값으로 저장되므로
		 아래처럼 비교연산이 가능하다. 또한 산술연상도 가능하다.
		 */
