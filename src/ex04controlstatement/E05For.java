 ...
 public class E05For {
	...
	public static void main(String[] args) {
		...
		/*
		 ...
		 3. 참일 때 실행문장을 실행
		 4. 증가(감소)식 실행
		 5. 조건검사(3,4,5번을 반복횟수만큼 실행)
		 6. 조건이 false일 때 for문 종료
		 */
		...
		/*
		 시나리오] 1 ~ 100 까지의 합을 구하는 프로그램을 for문을 이용하여 구현하시오.
		 */
		...
		/*
		 시나리오] for문을 이용하여 1~10사이의 정수 중
		 		2의 배수의 합을 구하는 프로그램을 작성하시오.
		 */
		...
		System.out.println("1~10사이 2의 배수의 합은 "+total);
	
		
		//방법2 : if문이나 삼향연산자 없이 구현
		total = 0;
		//증감연산자 대신 복합대입연산자도 사용가능함
		...
		//for문으로 무한루프 조건을 만들 때 아래와 같이 사용함
		int a = 1;
//		for(;;) {
...
//		}
		...
		/*
		 for문의 초기값을 외부(넓은지역)에서 선언하면 해당변수는 for문 안쪽(좁은지역)에서
		 사용할 수 있다. 즉, 아래에 선언한 변수 i는 main()함수의 지역변수가 된다.
		 */
