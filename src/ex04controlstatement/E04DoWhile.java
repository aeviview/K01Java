...
/*
 do ~while문
 	...
 	즉, 조건 검사 없이 무조건 한 번은 실행된다.
 	형식]
 		반복을 위한 초기값;
 		do {
 			실행문장;
 			반복문을 탈출하기 위한 증감식;
 			}while(조건식); <= 반드시 ;(세미클론)으로 마무리한다.
 */
...
public class E04DoWhile {
	...
	public static void main(String[] args) throws IOException {
		...
		/*
		 시나리오] E03 예제의 수열문제를 do~while문을 사용하여 작성하시오.
		 */	
	...
	/*
	 시나리오] 1부터 1000까지의 정수 중 4의 배수이거나 7의배수인 수의 합을
	 	구하여 출력하는 프로그램을 작성하시오.(단, do~while문을 사용)
	 */
		...
		System.out.println("1~1000 사이 4 or 7의 배수합 : "+ total);
		...
		/*
		 시나리오] 국어, 영어, 수학 점수를 사용자로부터 입력 받은 후
		 평균을 구해 A ~ F 학점을 판단하여 출력하는 프로그램을 작성하시오.
		 단, 사용자가 X,x(대소문자 구분없음)를 입력하면 프로그램이
		 종료되어야 하며 do ~while문으로 구현해야 한다.
		 */
		
		Scanner scanner = new Scanner(System.in); //대문자로 시작하는건 무조건 클래스
		int kor, eng, math, avg;                  //import 선언하고 사용해야함
		int exitCode;
