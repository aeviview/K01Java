...
public class E02SilsuType {
	...
	public static void main(String[] args) {
		...
		/*
		 실수자료형
		 - 정수형보다는 실수형이 더 큰 자료형이다.(0과 1사이 무한한 실수)
		...
		/*
		 - 실수형에서 기본형은 double이다.
		 - 소수점이 있는 데이터를 컴파일러 할 때는 무조건 double로 인식한다.
		...
		float f4 = (float)3.14;//형변환 후 대입함(권장사항아님)
		System.out.println("f4=" + f4);
		
		float f5 = 3.14F;//접미사 f를 통해 float를 표현함(권장사항)
		...
		double d1 = 3.14;
		double d2 = f6 + d1;//float + double = double(큰 쪽을 따라감)
