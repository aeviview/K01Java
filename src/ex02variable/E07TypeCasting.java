...
public class E07TypeCasting {
	...
	public static void main(String[] args) {
		...
		/*
		 자동형변환 : 작은상자의 데이터를 큰 상자에 대입할 때 자동으로 형변환이 일어난다.
		 */
		...
		/*
		 아래코드는 자동형변환은 아니다.
		CPU는 int보다 작은 자료형을 int로 간주하고 연산을 진행하며, 결과도 int로 반환한다.
		CPU의 특성이다.
		 */
		...
		/*
		 명시적 형변환 : 큰 상자의 자료를 작은 상자의 자료형에 할당해야 할 때 사용한다.
		...
		/*
		 소수점 아래부분이 버려지므로 데이터 손실이 있다.
		 따라서 특수한 경우가 아니라면 사용을 자제해야 한다.
		 */
		...
		/*
		 ...
		 명시적(강제) 형변환 후 대입해야 한다.
		 */
		
		char ch3 = 'A', ch4;
		int num4 = 2;
		
		//ch4 = ch3 + num4; // 타입이 맞지 않아 에러 발생됨
		ch4 = (char)(ch3 + num4);
