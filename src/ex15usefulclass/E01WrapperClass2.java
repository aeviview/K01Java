...
public class E01WrapperClass2 
{
	...
	public static void main(String[] args) 
	{
		...
		//(1)parseInt() : 숫자형식의 문자열을 숫자로 변경한다. 웹에서 많이 사용
		...
		System.out.println("10+strNumber를 숫자로 변경 : "+
							(10 + Integer.valueOf(strNumber)));//동일한기능 : 1010
		...
		//(3)isDigit () : 인자로 전달된 문자가 숫자인지 판단. 숫자일 때 true 반환
		...
		//(4)isLetter () : 문자여부를 판단한다. 특수기호나 숫자형은 false를 반환한다.
		...
		//(6)대소문자 판단하는 메소드
		//  - 영문자에만 적용되고 알파뱃이 아닌 경우 무조건 false를 반환한다.
		System.out.println("알파뱃 대소문자 판단");
	...
	/*
	 [시나리오] 주어진 문자열안에 몇 개의 공백문자(스페이스)가 있는지 판단하는 프로그램을 작성.
