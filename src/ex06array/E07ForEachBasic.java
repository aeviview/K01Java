...
/*
 <foreach문>
 	- 배열의 일부가 아니라 전체를 '참조'해야 할 때 주로 사용하는 개선된 for문이다.
...
public class E07ForEachBasic {
	...
	public static void main(String[] args) {
		...
		/*
		 배열 arr의 요소를 하나씩 참조하여 출력하고,
		 더 이상 참조할 요소가 없을 때 for문이 자동으로 종료된다.
		 */
		sum = 0;
		for(int e : arr)
		{
		...
		/*
		 2차원배열은 1차원배열 여러개를 쌓아놓은 형태이므로
		 출력시에는 우선 하나의 행(1차원배열)을 가져와서 각 요소를 하나씩 참조하여 출력한다.
		 */
