...
public class E05TwoDimArray02 {
	...
	public static void main(String[] args) {
		...
		/*
		 ...
		 1. 2차원 배열을 선언한다. 세로 2 , 가로 4
		 2. 난수를 이용하여 배열을 초기화한다.
		 3. 배열전체요소를 매개변수로 전달된 정수만큼 증가시킨다.
		 4. 증가되기 전, 후 배열을 출력한다.
		 5. 다음메소드명으로 구현한다. twoDimPlus()
		 */
	...
	//2차원 배열에 전달된 매개변수만큼 각 요소를 증가시키는 함수 : twoDimPlus
	static void twoDimPlus(int[][] arr2 ,int plusNum)
	{
		for(int i=0 ; i<arr2.length ; i++)
		{
			for(int j=0 ; j<arr2[i].length ; j++)
			{
				//매개변수로 전달된 plusNum만큼 각 요소를 증가시킨다.
				arr2[i][j] += plusNum;
			}
		}
	}
