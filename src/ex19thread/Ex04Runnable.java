...
/*
 [Thread클래스를 생성하는 두번째 방법]
 	...
 	다른 클래스를 상속받아야 한다면 Runnable 인터페이스를 구현해야 한다.
 */
...
public class Ex04Runnable 
{
	...
	public static void main(String[] args) 
	{
		...
		/*
		 ...
		 해당 방법도 결국은 Thread 클래스를 통해 쓰레드를 생성하게 된다.
		 */
		...
		try
		{
			/*
			 ...
			 즉, 해당 쓰레드가 하나의 작업이 종료되기를 기다렸다가 다음 쓰레드를 실행하게 된다.
			 쓰레드의 동시접근을 제한하는 기능을 가지고 있다(join)
			 */
			thread1.join();
			thread2.join();
		}
